...
void FluVNavigationSettingsItem::onThemeChanged()
{
    ...
    {
        FluStyleSheetUitls::setQssByFileName(FLURC("StyleSheet/light/FluVNavigationSettingsItem.qss"), this);
    }
    else
    {
        FluStyleSheetUitls::setQssByFileName(FLURC("StyleSheet/dark/FluVNavigationSettingsItem.qss"), this);
    }
}
