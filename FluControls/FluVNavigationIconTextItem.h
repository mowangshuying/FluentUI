  ...
  public slots:
    ...
    void onThemeChanged()
    {
        ...
        if (FluThemeUtils::isLightTheme())
        {
            ...
            FluStyleSheetUitls::setQssByFileName(FLURC("StyleSheet/light/FluVNavigationIconTextItem.qss"), this);
        }
        else
        {
            ...
            FluStyleSheetUitls::setQssByFileName(FLURC("StyleSheet/dark/FluVNavigationIconTextItem.qss"), this);
        }
    }
