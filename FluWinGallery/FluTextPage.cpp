...
void FluTextPage::onThemeChanged()
{
    ...
    {
        FluStyleSheetUitls::setQssByFileName(FLURC("StyleSheet/light/FluTextPage.qss"), this);
    }
    else
    {
        FluStyleSheetUitls::setQssByFileName(FLURC("StyleSheet/dark/FluTextPage.qss"), this);
    }
}
