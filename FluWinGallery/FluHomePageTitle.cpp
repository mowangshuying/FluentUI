...
FluHomePageTitle::FluHomePageTitle(QWidget* parent /*= nullptr*/) : FluWidget(parent)
{
    ...
    m_githubCard = new FluVCard(QPixmap(FLURC("res/HomeHeaderTiles/github-mark.png")), tr("GitHub"), tr("The latest Windows native controls and styles for your applications"), this);
    ...
    QString qss = FluStyleSheetUitls::getQssByFileName(FLURC("StyleSheet/light/FluHomePageTitle.qss"));
    setStyleSheet(qss);
}
