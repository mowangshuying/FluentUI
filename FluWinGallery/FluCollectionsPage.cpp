...
FluCollectionsPage::FluCollectionsPage(QWidget* parent /*= nullptr*/) : FluATitlePage(parent)
{
    ...
    auto tableViewCard = new FluHCard(QPixmap("../res/ControlImages/GridView.png"), tr("TableView"), tr("A control taht presents a collection of items in rows and columns."));
