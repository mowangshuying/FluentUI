...
FluDatePicker::FluDatePicker(QWidget* parent /*= nullptr*/) : FluDatePicker(true, parent)
{
 ...
 FluDatePicker::FluDatePicker(bool bYMD, QWidget* parent /*= nullptr*/) : FluWidget(parent)
{
     ...
     if (!bYMD)
     {
         ...
         m_hMainLayout->addWidget(new FluHSplitLine);
     ...
     m_datePickerView = new FluDatePickerView(bYMD);
