...
FluInfoBadgePage::FluInfoBadgePage(QWidget* parent /*= nullptr*/) : FluAEmptyPage(parent)
{
    ...
    FluInfoBadge::setInfoBadge(displayBox->getBodyWidget(), targetWidget1, FluInfoBadgeLevel::Info, 1);
    ...
    FluInfoBadge::setInfoBadge(displayBox->getBodyWidget(), targetWidget2, FluInfoBadgeLevel::Warn, 22);
