...
FluStatusAndInfoPage::FluStatusAndInfoPage(QWidget* parent /*= nullptr*/) : FluATitlePage(parent)
{
    ...
    auto progressRing = new FluHCard(QPixmap("../res/ControlImages/ProgressRing.png"), tr("ProgressRing"), tr("Shows the apps progress on a task, or that the app is performing ongoing work that does block user interaction."));
