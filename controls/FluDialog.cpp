...
FluDialog::FluDialog(QWidget* parent) : QDialog(parent)
{
    ...
    m_widgetLayout->addWidget(m_contentWidget, 1);
...
void FluDialog::closeEvent(QCloseEvent* event)
{
    QDialog::closeEvent(event);
}

void FluDialog::resizeEvent(QResizeEvent* event)
{
...
bool FluDialog::eventFilter(QObject* obj, QEvent* event)
{
