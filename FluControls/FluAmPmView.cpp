...
FluAmPmView::FluAmPmView(int nFixedW /*= 80*/, QWidget* parent /*= nullptr*/) : FluWidget(parent), m_nFixedW(nFixedW)
{
    ...
    setAmPm(tr("AM"), tr("PM"));
    setAm(true);
    FluStyleSheetUitls::setQssByFileName(FLURC("StyleSheet/light/FluAmPmView.qss"), this);
}
...
void FluAmPmView::onThemeChanged()
{
    ...
    else
    {
        ...
        FluStyleSheetUitls::setQssByFileName(FLURC("StyleSheet/dark/FluAmPmView.qss"), this);
    }
}
