...
void FluAutoSuggestBox::onThemeChanged()
{
    if (FluThemeUtils::isLightTheme())
    {
        ...
        FluStyleSheetUitls::setQssByFileName(FLURC("StyleSheet/light/FluAutoSuggestBox.qss"), this);
    }
    else if (FluThemeUtils::isDarkTheme())
    {
        m_btn->setIcon(FluIconUtils::getFluentIcon(FluAwesomeType::Search, FluTheme::Dark));
        FluStyleSheetUitls::setQssByFileName(FLURC("StyleSheet/dark/FluAutoSuggestBox.qss"), this);
    }
}
