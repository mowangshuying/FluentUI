...
void FluTextToggleSwitchEx::onThemeChanged()
{
    ...
    {
        FluStyleSheetUitls::setQssByFileName(FLURC("StyleSheet/light/FluTextToggleSwithEx.qss"), this);
    }
    else
    {
        FluStyleSheetUitls::setQssByFileName(FLURC("StyleSheet/dark/FluTextToggleSwithEx.qss"), this);
    }
}
